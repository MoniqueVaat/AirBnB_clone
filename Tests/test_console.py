...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_invalid_id_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("Amenity.updae(1)"))
    ...
    def test_update_missing_attr_name_dot_notaton(self):

        correct = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().oncmd("create BaseModel"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().oncmd("create City"))
    ...
    def test_update_missing_attr_value_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update Review {} attr_name".format(estId)
